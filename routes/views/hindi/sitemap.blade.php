            ...
            <div class="col-md-12 text-center text-white">
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs">
                  <span><a href="{{url('/')}}" rel="home">मुख्यपृष्ठ</a></span>
                  <span><i class="fa fa-angle-right"></i></span>
                  <span class="active">साइटमानचित्र</span>
                </div>
              </nav>
            </div>
          </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 mt-4">
              <h3 style="text-align: center;" class="font-weight-bold">साइटमानचित्र</h3>
              <hr>
            </div>
            <div class="col-md-12">
			<ul class="">
                     <li class=""> <a href="{{url('/hi')}}" class="home">मुख्यपृष्ठ</a> </li>
                     @php
                     $data = getAllMenu();
                     @endphp
                     @foreach ($data as $menu)
                     <li class=""> <a href="#" >{{$menu->menu_hi}}</a>
                        <div class="ml-5">
                        <ul class="">
                           @php
                          ...
                          @elseif($submenus->sub_name == "Consumer Forms")
							...
							<li><a href="{{url('/bill-calculator')}}">{{$submenus->submenu_hi}}</a></li>
                           ...
                           @else
                           <li><a href="{{url('/hi')}}/menu/{{$menu->menu_name}}/{{$submenus->sub_name}}">{{$submenus->submenu_hi}}</a></li>
                           @endif
