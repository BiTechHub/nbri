            ...
            <div class="col-md-12 text-center text-white">
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs pull-right" style="font-weight: bold;">
                  ...
                  <span class="active">वीडियो गैलरी</span>
                </div>
              </nav>
            </div>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 mt-4">
              <h3 style="text-align: center;" class="font-weight-bold">वीडियो गैलरी</h3>
              <hr>
            </div>
                ...
                <div class="gallery-item design col-md-4 m-p">
                  <div class="thumb mt-4">
                    ...
                    <div class="text-holder">
                      <div class="title text-center"><b>{{$vid->heading_hi}}</b></div>
                    </div>
                  </div>
                </div>
