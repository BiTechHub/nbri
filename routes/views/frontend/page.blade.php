          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td>{{$i++}}</td>
                <td>
<a href="<?php echo url('/') . '/uploads/' . $itam->image; ?>" target="_blank">
    <?php echo $itam->heading; ?>
    <span>
        <img src="<?php echo url('/') . '/img/pdf.png'; ?>" alt="">
        -– 
        <?php if($itam->lang): ?>
            (भाषा – हिंदी)
        <?php else: ?>
      ...
      <div class="col-md-12">
        ...
        @endforeach
          ...
          <div class="col-md-12">
            <h4 class="text-center" id="directori_name">Phone Directory</h4>
			...
			<div class="col-md-4 mt-4">
			  <div class="card" >
				...
				<div class="card-body p-2">
				 ...
				 <a href="http://jtp.uppcl.org/online/frmLogin.aspx" style="color: #ff7c1b;font-weight: 600;" >Apply For New Domestic Connection &amp; Comm. / Indus. Connection (Upto 20KW) (Jhatpat Connection)</a></p>
				  </p>
				</div>
			  </div>
			</div>
			<div class="col-md-4 mt-4">
			  <div class="card" >
				...
				<div class="card-body p-2">
				  <h5 class="card-title"></h5>
				  <p class="card-text" style="text-align: center;">
				 <a href="http://niveshmitra.up.nic.in/" style="color: #ff7c1b;font-weight: 600;" >Apply for New Electricity Connection for Commerical, Industrial & Institutional Users (Above 20KW) (Nivesh Mitra)</a></p>
				  </p>
				</div>
			  </div>
			</div>
			<div class="col-md-4 mt-4">
			  <div class="card" >
				...
				<div class="card-body p-2">
				  <h5 class="card-title"></h5>
				  <p class="card-text" style="text-align: center;">
				 <a href="http://ptw.uppcl.org/online/account/login" style="color: #ff7c1b;font-weight: 600;" >Apply for New Electricity Connection for Private Tube Well</a></p>
				  </p>
				</div>
			  </div>
			</div>
			<div class="col-md-4 mt-4">
			  <div class="card" >
				...
				<div class="card-body p-2">
				  <h5 class="card-title"></h5>
				  <p class="card-text" style="text-align: center;">
				 <a href="https://jtp.uppcl.org/online/frmLogin.aspx" style="color: #ff7c1b;font-weight: 600;" >Apply for single point to multi point connection</a></p>
				  </p>
				</div>
			  </div>
			</div>
