        ...
        <div class="col-md-12 text-center text-white" >
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs pull-right" style="font-weight: bold;">
                  ...
                  <span><i class="fa fa-angle-right"></i></span>
                  <span class="active">Tenders & Notice</span>
                </div>
              </nav>
            </div>
        </div>
      ...
      <div class="section-content">
        <div class="row">
          <div class="col-md-12 my-4 border-bottom">
            <div class="col-md-6">
              <h3 style="" class="font-weight-bold">Tenders & Notice</h3>
            </div>
            <div class="col-md-6">
              <a class="btn btn-danger pull-right" href="{{url('/tender-notice-archive')}}">Tenders & Notice Archive</a>
            </div>
          </div>
          <div class="col-md-12 my-4">
            <div class="col-md-4">
              <a class="btn btn-warning" href="{{url('/')}}/uploads/Hindi-font.zip" title="Hindi Fonts (Language - Hindi)" target="_blank"><i class="fa fa-file-archive-o" aria-hidden="true"></i> Hindi Fonts (Language - Hindi)</a>
            </div>
            <div class="col-md-4">
              <a class="btn btn-info" href="{{url('/')}}/uploads/Adobe_Acrobat.zip" title="Hindi Fonts (Language - Hindi)" target="_blank"><i class="fa fa-file-archive-o" aria-hidden="true"></i> Acrobat Reader (Language - English)</a>
            </div>
            <div class="col-md-4">
              <a class="btn btn-warning" href="{{url('/')}}/uploads/Common-Tender-Documents.zip" title="Hindi Fonts (Language - Hindi)" target="_blank"><i class="fa fa-file-archive-o" aria-hidden="true"></i> Common Tender Documents (Language - English)</a>
            </div>
          </div>
