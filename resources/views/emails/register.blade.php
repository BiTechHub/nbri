        ...
        <div class="container">
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <p>Thanks you getting in touch!
                     


                    </p>
                    <div>
<p>   we have receive your booking request on date <span class="data-value">{{$application->created_at}}</span><br>
    your application no is: <span class="data-value">{{$application->application_id}}<br>
        visit to check your <span class="data-value"> <a href="#">booking status</a></span></p>
                                 
                    </div>
                    
             <p>This is not a booking confirmation, your booking status will be updated in intimated 7-15 days before the arrival date base on the availability of rooms </p>       
