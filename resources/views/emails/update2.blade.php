            ...
            <div class="card shadow-sm">
                <div class="card-body text-center">
                    ...
                    <div class="booking-details">
                        ...
                        <p><strong>Room Category:</strong> <span class="data-value">Executive Room</span></p>
                        <p><strong>Arrival Date & Time:</strong> <span class="data-value">{{ $application->date_of_arrival }} {{ $application->arrival_time }}</span></p>
                        <p><strong>Departure Date & Time:</strong> <span class="data-value">{{ $application->date_departure_date }} {{ $application->departure_time }}</span></p>
                    </div>
