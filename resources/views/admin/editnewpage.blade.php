          ...
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="{{url('/')}}/admin-panel/allpages" style="color:red">Manage Page</a></li>
              </ol>
            </nav>
          </div>
        </div>
		  ...
		  <div class="row">
			<div class="col-12">
			  ...
			  <div class="box">
				...
				<!-- /.box-header -->
				<div class="box-body">
				  <form action="{{ route('admin-panel.updatenewpage') }}" method="post" enctype="multipart/form-data">
                    @if(session('status'))
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="lang" id="" value="{{$scontent->language}}" readonly class="form-control">
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="heading" id="" value="{{$scontent->heading}}" class="form-control">
                  ...
                  <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="slug" id="slug" value="{{$scontent->slug}}" readonly class="form-control">
                      <span class="text-danger"> @error('slug') {{$message}} @enderror </span>
                    </div>
                  </div>
