		...
		<div class="box-body">
			...
			<div class="box mt-20">
				<div class="box-header">
					<h4 class="box-title">Search Page</h4>
                    <div class="" style="">
                       <input type="text" name="keyword" placeholder="Type Page Title" class="form-control">
                    </div>
				</div>
						...
						<table id="complex_header" class="table table-striped table-bordered" style="width:100%">
							...
							<tbody>
								...
								<tr>
                                  ...
                                  <td>{{$item->language}}</td>
									<td><a href="{{url('/')}}/admin-panel/editnewpage/{{$item->id}}" class="btn btn-success">Edit</a></td>

									<td><a href="{{url('/')}}/admin-panel/delnewpage/{{$item->id}}" class="delete btn btn-danger">Delete</a></td>
