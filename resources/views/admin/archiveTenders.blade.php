	  ...
	  <div class="container">
		...
		<div class="content-header">
			<div class="d-flex align-items-center">
				<div class="mr-auto">
					<h3 class="page-title">Archive Tenders</h3>
			  ...
			  <div class="row">
				...
				<div class="box">
					<div class="box-header">
                     ...
                     @endif
                        <a class="btn btn-warning mb-3 ml-3" href="{{url('/')}}/admin-panel/currentTenders" style="float:right;">Current Tenders</a>
							...
							<table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <td>
										@if($item->status == "0")
                                            <a href="{{url('/admin-panel')}}/activate/{{$item->id}}" class="btn btn-danger btn-sm"><i class="fa fa-times-circle-o" aria-hidden="true"></i>
</a>
                                        @else
                                      ...
                                      <td>
                                        <a href="{{url('/admin-panel')}}/add_listing/{{$item->id}}" class="btn btn-warning btn-sm">Add PO / WO</a>
                                      </td>
                                      <td>
                                        <a href="{{url('/admin-panel')}}/view_listing/{{$item->id}}" class="btn btn-primary btn-sm">View PO / WO</a>
                                      </td>
									</tr>
									@php
									$i++;
