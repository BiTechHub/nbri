    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form action="{{ route('admin-panel.uploadslider') }}" method="post" enctype="multipart/form-data">
                @if(session('status'))
          ...
          <div class="box mt-20">
            <div class="box-header">
              <h4 class="box-title">Manage Slider Photos</h4>
            </div>
            <div class="box-body">
                    ...
                    <tr>
                      ...
                      <td>
                        @if($item->status == 'Active')
                      	<a href="{{url('/')}}/admin-panel/slider_active/{{$item->id}}" class="btn btn-success btn-sm">Active</a>
                        @else
                        <a href="{{url('/')}}/admin-panel/slider_deactivate/{{$item->id}}" class="btn btn-danger btn-sm">Deactivate</a>
                        @endif
                      </td>
                      <td><a href="{{url('/')}}/admin-panel/slider/{{$item->id}}" class="delete btn btn-danger" title="Delete Slider Photos"><i class="fa fa-trash"></i></a></td>
