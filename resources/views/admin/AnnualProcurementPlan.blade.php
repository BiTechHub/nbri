...
<div class="content-header">
  <div class="d-flex align-items-center">
    <div class="mr-auto">
      <h3 class="page-title">Upload Annual Procurement Plan</h3>
...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-body">
      <div class="row">
        <div class="col">
          <form action="{{ route('admin-panel.AnnualProcurementPlan') }}" method="post" enctype="multipart/form-data">
            @if(session('status'))
          ...
          <div class="table-responsive">
            <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
              ...
              <tbody>
                ...
                <tr>
                    <td>{{ $i }}</td>
                    <td><a target="_blank" href="{{ url('/') }}/uploads/AnnualProcurementPlan/{{ $item->url }}">{{ $item->title }}</a></td>
                    <td id="urlCell{{ $i }}">{{ url('/') }}/uploads/AnnualProcurementPlan/{{ $item->url }}</td>
                    <td>
                    ...
                    <td>
                                        ...
                                        <div class="modal fade" id="update_modal{{$item->id}}" aria-hidden="true">
                                          <div class="modal-dialog">
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <form action="{{ route('admin-panel.UpdateAnnualProcurementPlan') }}" method="post" enctype="multipart/form-data"> 
                                                  @csrf
                                                  <div class="row">
                                                    <div class="col-12">
                                                      ...
                                                      <div class="form-group">
                                                        <h5>Title <span class="text-danger">*</span></h5>
                                                        <div class="controls">
                                                          <input type="text" name="title" class="form-control"  value="{{$item->title}}"> 								</div>
                                          ...
                                          <a href="{{url('/')}}/admin-panel/delAnnualPro/{{$item->id}}" class="delete btn btn-danger"><i class="fa fa-trash"></i></a></td>
                </tr>
                @php $i++; @endphp
                @endforeach
            </tbody>
