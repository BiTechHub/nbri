  ...
  <div class="container">
    ...
    <div class="content-header">
      <div class="d-flex align-items-center">
        <div class="mr-auto">
          <h3 class="page-title">Manage Garden Category</h3>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item" aria-current="page">Control</li>
                <li class="breadcrumb-item active" aria-current="page">Garden Category</li>
              </ol>
            </nav>
          </div>
        </div>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form action="{{ route('admin-panel.uploadAddNewGardenCategory') }}" method="post" enctype="multipart/form-data">
                @if(session('status'))
                   ...
                   @php $i = 1; @endphp
                    ...
                    <tr>
                        ...
                        <td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('/') }}/admin-panel/update_NewGardenCategory" method="post" enctype="multipart/form-data">
                                                @csrf
                          ...
                          <br>
                        <a href="{{url('/')}}/admin-panel/delNewGardenCategory/{{$item->id}}" class="delete btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                    @php $i++; @endphp
                    @endforeach
