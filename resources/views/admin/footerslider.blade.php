  ...
  <div class="container">
    ...
    <div class="content-header">
      <div class="d-flex align-items-center">
        <div class="mr-auto">
          <h3 class="page-title">Manage Footer Slider</h3>
          <div class="d-inline-block align-items-center">
            <nav>
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="mdi mdi-home-outline"></i></a></li>
                <li class="breadcrumb-item" aria-current="page">Control</li>
                <li class="breadcrumb-item active" aria-current="page">Footer Slider Images</li>
              </ol>
            </nav>
          </div>
        </div>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form action="{{ route('admin-panel.uploadfooterslider') }}" method="post" enctype="multipart/form-data">
                @if(session('status'))
          ...
          <div class="box mt-20">
            <div class="box-header">
              <h4 class="box-title">Manage Footer Slider Photos</h4>
            </div>
            <div class="box-body">
                ...
                <table id="complex_header" class="table table-striped table-bordered display" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="{{url('/')}}/uploads/footerslider/{{$item->image}}" style="width:150px; height:150px;"></td>
                   
                      <td><a href="{{url('/')}}/admin-panel/footerslider/{{$item->id}}" class="delete btn btn-danger" title="Delete Slider Photos"><i class="fa fa-trash"></i></a></td>
