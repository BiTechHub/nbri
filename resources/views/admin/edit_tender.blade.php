              ...
              <form action="{{ route('admin-panel.EditTender') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-6">
                      ...
                      <div class="controls">
                        <input type="date" name="advt_date" value="{{$tender_master->advt_date}}" class="form-control">
                      </div>
                  ...
                  <div class="col-3">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" autocomplete="off" placeholder="Start Date" name="pre_start_date" id="start_date" value="{{$tender_master->pre_start_date}}" />
                    </div>
                     @error('pre_start_date') <div class="text-danger"> {{ $message }}</div> @enderror
                  </div>
                  <div class="col-3">
                    <div class="form-group">
                      <label>Pre Bid Meeting Start Time</label>
                      <input type="time" class="form-control" autocomplete="off" placeholder="Start Time" name="pre_start_time" id="start_time" value="{{$tender_master->pre_start_time}}" />
                    </div>
                     @error('pre_start_time') <div class="text-danger"> {{ $message }}</div> @enderror
                  </div>
                  ...
                  <div class="form-group col-6" id="rel_file">
