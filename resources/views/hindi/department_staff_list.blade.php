                ...
                <tbody>
                  @foreach($staffcontent as $stcontent)
                    ...
                    <tr>
                        ...
                        <td width="200"><a href="{{url('/')}}/hi/ViewProfile/{{$stcontent->id}}/{{$stcontent->name}}">{{$stcontent->name_hi}}</a></td>
                        @else
                        <td width="200">{{$stcontent->name_hi}}</td>
                        @endif
                        <td width="150">{{$stcontent->deg_hi}}</td>
                        ...
                        <td width="200">
                         @foreach($ids as $id)
                             ...
                             @endphp
                             @if($area)
                                {{ $area->area_hi }}@if(!$loop->last), @endif
                             @endif
                         @endforeach
                      </td> -->
