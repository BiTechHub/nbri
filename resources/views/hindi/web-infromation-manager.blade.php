        ...
        <div class="col-md-12 text-center text-white">
          <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
            <div class="breadcrumbs pull-right" style="font-weight: bold;">
              ...
              <span class="active">वेब सूचना प्रबंधक</span>
            </div>
          </nav>
        </div>
  ...
  <div class="container">
    <div class="section-content">
      <div class="row">
        ...
        <h3 style="text-align: center;" class="font-weight-bold">वेब सूचना प्रबंधक</h3>
      </div>
...
<h4 class="panel-title">वेब सूचना प्रबंधक - पश्चिमांचल विद्युत वितरण निगम लिमिटेड</h4>
</div>
...
<td width="25%">नाम</td>
<td width="2%">:</td>
<td>श्री रवि कुमार</td>
</tr>
<tr>
<td width="25%">पद</td>
<td width="2%">:</td>
<td>अधिशासी अभियंता&nbsp;</td>
</tr>
<tr>
<td width="25%">ईमेल आईडी</td>
<td width="2%">:</td>
<td>control.room@pvvnl.org</td>
</tr>
<tr>
<td width="25%">मोबाइल</td>
<td width="2%">:</td>
<td>+91-9412749213</td>
</tr>
<!--<tr>
