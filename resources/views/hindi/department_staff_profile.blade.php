        ...
        <div class="row d-flex align-items-center gap-2">
            <div class="col-md-3 text-center">
                <div class="profile-img-container ">
                    <img src="{{url('/')}}/uploads/staffPics/{{$staffcontent1->image}}" class="profile-img" alt="{{$staffcontent1->name_hi}}">
                </div>
            </div>
            <div class="col-md-9">
                <table class="table table-borderless">
                    <tbody>
                        ...
                        <tr>
                            <td class="form-label">पूरा नाम:</td>
                            <td class="form-label">{{$staffcontent1->name_hi}}</td>
                        </tr>
                        <tr>
                            <td class="form-label">पद का नाम:</td>
                            <td class="form-label">{{$staffcontent1->deg_hi}}</td>
                        </tr>
                        <tr>
                            <td class="form-label">पता:</td>
                            <td class="form-label">{{$staffcontent1->address_hi}}</td>
                        </tr>
                        <tr>
                            <td class="form-label">मेल:</td>
                            <td class="form-label">{{ str_replace(['@', '.'], ['[at]', '[dot]'], $staffcontent1->email) }}</td>
                        </tr>
                        <tr>
                            <td class="form-label">संपर्क:</td>
