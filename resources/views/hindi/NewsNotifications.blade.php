...
<div class="row">
  ...
  <h1 class="page-title">समाचार और अधिसूचना</h1>
...
<article data-history-node-id="923" class="node node--type-about-stqc node--view-mode-full">
  ...
  <div class="node__content">
            ...
            <div class="clearfix text-formatted field field--name-body field--type-text-with-summary field--label-hidden field__item">
              <table class="table" style="border: 1px dashed #ccc;">
                <thead class="" style="background-image:url('https://nbri.ulbup.in/live/img/background.jpg');">
                  <tr>
                    <th scope="col" width="40">#</th>
                    <th scope="col" width="600">शीर्षक</th>
                     <th scope="col" width="60">देखें</th>
                  </tr>
                </thead>
                <tbody>
                  @php
                  $i=1;
                  @endphp
                  @foreach($news_n as $tt)
                  <tr>
                    <th scope="row">{{$i}}</th>
                    <td><a href="{{url('/')}}/" target="_blank">{{$tt->subject_hi}}</a></td>
                    <td><a href="{{url('/')}}/uploads/news/{{$tt->file_name}}" target="_blank">View</a></td>
                  </tr>
                   @php
                  $i++;
                  @endphp
