            ...
            <div class="col-md-12 text-center text-white">
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs pull-right" style="font-weight: bold;">
                  ...
                  <span class="active">कार्यालय आदेश पुरालेख</span>
                </div>
              </nav>
            </div>
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-6">
              <h3 style="" class="font-weight-bold">कार्यालय आदेश पुरालेख</h3>
            </div>
            <div class="col-md-6">
              <a class="btn btn-danger pull-right" href="{{url('/hi/Office-Orders')}}">कार्यालय आदेश</a>
            </div>
          </div>
