        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="title">{{$ccat}}</h2>
              <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
                <div class="breadcrumbs">
                  <span><a href="#" rel="home">Home</a></span>
                  <span><i class="fa fa-angle-right"></i></span>
                  <span><a href="#">{{$mcat}}</a></span>
                  <span><i class="fa fa-angle-right"></i></span>
                  <span class="active">{{$scat}}</span>
                  <span><i class="fa fa-angle-right"></i></span>
                  <span class="active">{{$ccat}}</span>
                </div>
              </nav>
            </div>
          </div>
            ...
            <div class="accordion tm-accordion accordion-classic accordion-theme-colored1" id="accordion500">
              ...
              <div class="accordion-item">
                <h2 class="accordion-header" id="heading{{$v}}">
                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{$v}}" aria-expanded="true" aria-controls="collapse{{$v}}">
                    <strong>{{$fq->quest}}</strong>
                  </button>
                </h2>
                <div id="collapse{{$v}}" class="accordion-collapse collapse @if($v==501) show @endif" aria-labelledby="heading{{$v}}" data-bs-parent="#accordion500">
