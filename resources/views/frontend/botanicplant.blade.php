...
<div class="inner_header">
    ...
    <ol class="breadcrumb" style="font-size: 1.5rem; font-weight:bold; color:orange !important;">
          ...
          <li class="breadcrumb-item">
                  Welcome to Distant Research Centre, Banthra, CSIR-NBRI
              </li>
        </ol>
  </nav>
...
<div class="row">
  ...
  <h1 class="page-title">Welcome to Distant Research Centre, Banthra, CSIR-NBRI</h1>
    ...
    <tbody>
      ...
      <tr>
        <td colspan="4" style="text-align: center; padding: 15px;">
          <img src="{{url('/')}}/uploads/DRC_image_files/{{$plant_detail->image}}" alt="{{$plant_detail->plant_name_en}}" style="max-width: 100%; height: auto; border: 1px solid #ccc;">
        </td>
      </tr>
    </tbody>
  </table>
