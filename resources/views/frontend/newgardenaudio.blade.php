...
@if($plant_detail->audio_lang == '2')
<div class="col-md-12 innercontent" style="margin-top:20px">   
  <div class="cont diversity-scientists">
    <div class="row">
     <div class="col-md-12 text-center"> 
      <h2 id="demo" align="center"> कृपया हिंदी में ऑडियो विवरण सुनने के लिए दबाएँ </h2>  
      </div>

    	<div class="col-md-12 text-center" style="margin-top:20px"> 
      	<audio id="myAudio" controls="" style="width: 350px; height: 50px">
         <source src="{{url('/')}}/uploads/audio_hi/{{$plant_detail->file_hi}}" type="audio/mpeg"> 
...
@elseif($plant_detail->audio_lang == '1')
    ...
    <div class="row">
      ...
      <div class="col-md-12 text-center" style="margin-top:20px">
        <audio id="myAudio1" controls="" style="width: 350px; height: 50px">
         <source src="{{url('/')}}/uploads/audio_en/{{$plant_detail->file_en}}" type="audio/mpeg"> 
        Your browser does not support the audio element.
       </audio>
     </div>
   </div>
...
@elseif($plant_detail->audio_lang == '3')
<div class="col-md-12 innercontent" style="margin-top:20px">   
  <div class="cont diversity-scientists">
    <div class="row">
     <div class="col-md-12 text-center"> 
