          ...
          <div class="row">
            ...
            <nav class="breadcrumbs" role="navigation" aria-label="Breadcrumbs">
              <div class="breadcrumbs pull-right" style="font-weight: bold;">
                ...
                <span class="active">Office Orders Archive</span>
              </div>
            </nav>
          </div>
          </div>
      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-6">
              <h3 style="" class="font-weight-bold">Office Orders Archive</h3>
            </div>
            <div class="col-md-6">
              <a class="btn btn-danger pull-right" href="{{url('/Office-Orders')}}"> Office Orders</a>
            </div>
          </div>
