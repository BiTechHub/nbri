...
<meta name="description" content="Official Website of Pashchimanchal Vidyut Vitran Nigam Limited, Government of Uttar Pradesh">
<meta name="keywords" content="Official Website of Pashchimanchal Vidyut Vitran Nigam Limited, Government of India, PVVNL, Pashchimanchal Vidyut Vitran Nigam Limited">
<meta name="author" content="Pashchimanchal Vidyut Vitran Nigam Limited">
...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-Y5BWEHK0CC"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-Y5BWEHK0CC');
</script>
...
.banner-wrapper .flex-control-nav:after {
    ...
    border-bottom: 40px solid #DB5E00 !important;
}
  ...
  <div class="region region-header-top">
    <div id="block-cmf-content-header-region-block" class="block block-cmf-content first last odd">
      ...
      <div class="wrapper common-wrapper">
        <div class="container-fluid common-container four_content top-header">
          ...
          <div class="common-right clearfix">
            <ul id="header-nav">
             ...
             <li class="ico-skip cf"><a target="_blank" href="https://old.pvvnl.org" title=""><i class="fa fa-calendar" aria-hidden="true"></i>
 {{ now()->format('d-m-Y') }}</a>
                 </li>
...
<span> Ministry of  / Department Name</span>
      ...
      <div class="header-right clearfix">
        <div class="right-content clearfix">
          ...
          <div class="float-element">
              <a class="sw-logo1" target="_blank" title="Skill India, External link that open in a new windows" style="margin-right: -350%;">
              <img src="up-logo.png" alt="Skill India" style="width: 91px;margin-top: 8px;">
            </a>
            <a class="sw-logo1" target="_blank" title="Skill India, External link that open in a new windows">
                
              <img src="indian-flag.gif" alt="Skill India" style="width: 91px;margin-top: 8px;">
            </a>
  ...
  <!--/.header-wrapper-->
  <section class="wrapper megamenu-wraper" style="background: var(--Primary-gradient, linear-gradient(90deg, #DB5E00 0%, #003630 100%));">
    <div class="container-fluid common-container four_content">
      ...
      <nav class="main-menu clearfix" id="main_menu" style="">
        <ul class="nav-menu">
          <li class="nav-item"> <a href="{{url('/')}}" class="home" style="background: #003630;"><i class="fa fa-home"></i></a> </li>

          @foreach ($data as $menu)
          
         <!--{{url('/en')}}/{{$menu->id}}/{{str_replace(' ', '-', $menu->menu_name)}}-->

          <li class="nav-item"> <a href="#" class="{{ isset($page_id) && $menu->menu_name == $page_id ? 'shani' : '' }}
            ">{{$menu->menu_name}}</a>
            <div class="sub-nav">
              <ul class="sub-nav-group">
                ...
                @elseif($submenus->sub_name == "Photo Gallery")
                <li><a href="{{url('/gallery')}}">{{$submenus->sub_name}}</a></li>
                
            @elseif($submenus->sub_name == "Video Gallery")
                <li><a href="{{url('/video')}}">{{$submenus->sub_name}}</a></li>
                ...
                <li><a href="https://pvvnl.org/Tenders-Notice">{{$submenus->sub_name}}</a></li>
          ...
          @endforeach
          <li class="nav-item"> <a href="{{url('/en')}}/Cyber-Security" class="">Cyber Security Corner</a> 
