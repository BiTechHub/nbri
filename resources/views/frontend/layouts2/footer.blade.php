...
<div class="row">
  ...
  <div class="footer-sidebar footer-3 col-xs-12 col-sm-6 col-md-3">
    ...
    {{--<div id="block-14" class="widget widget_block"><p tabindex="0" data-swp-font-size="14px" style="font-weight: bold;"><span id="last_modified_text">Last Updated Date : </span>--}}
      @php
     ...
     {{-- @if ($latestLog)
      ...
      @php
          $ip = request()->ip();
          $check_ip = DB::table('visitors')->where('ip', $ip)->orderby('id', 'desc')->first();
          if ($check_ip) {
          if ($check_ip->date != date('Y-m-d')) {
          DB::table('visitors')->insert(['ip' => $ip, 'date' => date('Y-m-d')]);
          }
          } else {
          DB::table('visitors')->insert(['ip' => $ip, 'date' => date('Y-m-d')]);
          }

          $check_count = DB::table('visitors')->count('ip');



          @endphp
      {{--</p></div><div id="srs_shc_widget-6" class="widget widget_srs_shc_widget"><span class="visitors" tabindex="0" style="font-weight: bold;background: url({{url('/')}}/img/bg2.png);font-weight: bold;padding: 3px 5px;">Site Visitors :  {{ $check_count + 5853938 }}</span></div>  --}}                 
      </div>
...
<div class="col-md-10">
  ...
  <p tabindex="0" style="margin-bottom:8px !important;" data-swp-font-size="14px">For any query regarding this website, Please contact the <a href="{{url('/web-infromation-manager')}}" style="color: white;" class="external selected" title="&quot;Web Information Manager&quot;"><span>"Web Information Manager"</span></a></p>
  
  <!--<p tabindex="0" style="margin-bottom:8px !important;" data-swp-font-size="14px">Name : Sri. Ravi Kumar (Executive Engineer (Information Technology))</p>
  <p tabindex="0" style="margin-bottom:8px !important;" data-swp-font-size="14px">Email ID : control.room@pvvnl.org</p>
...
<div class="col-md-12">
  <p style="float: right; color: rgb(255, 255, 255); font-weight: 400;" tabindex="0" data-swp-font-size="14px"><b>Last Updated Date : @if ($latestLog) {{ $latestLog->created_at }} @else No Update. @endif </b> | <span class="visitors" tabindex="0" style="font-weight: bold;background: url({{url('/')}}/img/bg2.png);font-weight: bold;padding: 3px 5px;">Site Visitors :  {{ $check_count + 5853938 }}</span> | <b>Developed By : <a class="Business Innovations mr-5" target="_blank" href="https://www.businessinnovations.in/" style="color: #ff9600;" title="Business Innovations">Business Innovations</b></a></p>
</div>
</div>
</div>
