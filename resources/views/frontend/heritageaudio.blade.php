...
<div class="row">
  ...
  <h1 class="page-title">Welcome to Heritage Garden</h1>
     ...
     <div class="col-md-12 text-center"> 
      <h2 id="demo" align="center"> कृपया हिंदी में ऑडियो विवरण सुनने के लिए दबाएँ </h2>  
    	...
    	<div class="col-md-12 text-center" style="margin-top:20px"> 
         ...
         <source src="{{url('/')}}/uploads/HeritageAudioFiles/{{$plant_detail->file_hi}}" type="audio/mpeg"> 
    ...
    <div class="row">
      ...
      <div class="col-md-12 text-center" style="margin-top:20px">
        <audio id="myAudio1" controls="" style="width: 350px; height: 50px">
         <source src="{{url('/')}}/uploads/HeritageAudioFiles/{{$plant_detail->file_en}}" type="audio/mpeg"> 
        Your browser does not support the audio element.
       </audio>
     </div>
   </div>
