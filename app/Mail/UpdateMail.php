...
class UpdateMail extends Mailable
{
       ...
       public function build()
    {
         ...
         $bookings = DB::table('bookings')->where('application_id', $this->application->application_id)->first();
         $roomtype = DB::table('guestroom_master')->where('id', $bookings->room_type)->first();
        ...
        return $this->view('emails.updates')
                    ->with([
